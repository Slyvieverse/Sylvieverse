<x-admin-layout>
    ...
    <div class="py-8 md:py-12">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800/95 rounded-2xl p-6 md:p-8 border border-gray-200 dark:border-purple-700/50 shadow-2xl transition-all duration-300 hover:shadow-purple-900/50">
                ...
                <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                        ...
                        <div class="relative">
                            ...
                            >
                                ...
                                @foreach ($categories as $category)
                                    <option value="{{ $category->id }}" class="bg-white dark:bg-gray-800" {{ old('category_id') == $category->id ? 'selected' : '' }}>
                                        {{ $category->name }}
                                    </option>
                                @endforeach
                            </select>
                            {{-- Custom chevron for select field --}}
                        ...
                        <div class="field-group">
                            ...
                            <div class="relative">
                                <select
                                    ...
                                    required
                                >
                                    <option value="active" class="bg-white dark:bg-gray-800" {{ old('status') === 'active' ? 'selected' : '' }}>Active</option>
                                    <option value="inactive" class="bg-white dark:bg-gray-800" {{ old('status') === 'inactive' ? 'selected' : '' }}>Inactive</option>
                                </select>
                                {{-- Custom chevron for select field --}}
                                <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700 dark:text-gray-300">
                                    <svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z"/></svg>
                    ...
                    <div class="field-group pt-4">
                        <label for="image_url" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Product Image (Upload) <span class="text-red-500">*</span></label>
                        <div class="p-4 border border-dashed border-gray-400 dark:border-purple-800 rounded-lg bg-gray-50 dark:bg-gray-700/50">
                             <input
                                type="file"
                                name="image_url"
                                id="image_url"
                    ...
                    <hr class="border-gray-300 dark:border-purple-700/30 mt-8 mb-4">
